...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QMQTT__NetworkInterface_t, stringdata) + ofs \
...
void QMQTT::NetworkInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (NetworkInterface::*_t)(const QList<QSslError> & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetworkInterface::sslErrors)) {
                *result = 4;
            }
        }
    }
...
void *QMQTT::NetworkInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QMQTT__NetworkInterface.stringdata))
