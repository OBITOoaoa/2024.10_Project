...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QMQTT__RouteSubscription_t, stringdata) + ofs \
...
void *QMQTT::RouteSubscription::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QMQTT__RouteSubscription.stringdata))
